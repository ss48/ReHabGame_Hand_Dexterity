...
namespace Mediapipe.Unity
{
  public class AutoFit : MonoBehaviour
  {
    ...
    private void LateUpdate()
    {
     ...
     if(_fitMode == FitMode.BottomRight)
     {
        var ar = width / height;
        h = parentRect.height * 0.15f;
        rectTransform.offsetMax = new Vector2(parentRect.width * 0.5f - 10, -parentRect.height * 0.5f + h + 10);
        rectTransform.offsetMin = new Vector2(rectTransform.offsetMax.x - h * ar, rectTransform.offsetMax.y - h);
